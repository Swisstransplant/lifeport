...
Please be sure to cite the following paper in your research when utilizing EXAM or the Swisstranplant `swt` package for machine perfusion data analysis.
:::
...
Please contact me for any inqueries regarding the analysis of perfusion data <simon.schwab@swisstransplant.org>, I'm happy to help.
